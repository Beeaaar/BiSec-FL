...
class MNISTClient(fl.client.NumPyClient):
    ...
    def fit(self,parameters,config):
        ...
        train(self.model,trainloader,DEVICE,epochs=2)
    ...
    def encrypt_parameters(self,request):
        ...
        print("In myclient:118,plain_text(para or gra):",poly_weights.poly_to_list()[:8])
        print(f"c0: {c0[:8]}")
        print(f"c1: {c1[:8]}")
        return c0, c1
    ...
    def compute_decryption_share(self,csum1):
        ...
        print("In myclient:133,Compute D1:",d1[:8])
        return d1
